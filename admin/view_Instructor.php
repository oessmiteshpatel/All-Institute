...
?>
						...
						<td>
							...
							<button type="button" class="btn-md btn-icon btn-link p4" data-toggle="modal" data-target="#myModal" onClick="delete1(<?php echo $row['InsId']; ?>)"> <i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
...
{ //alert(id);
    ...
    "oLanguage": {
      "sLengthMenu": "Show _MENU_ Instructors",
