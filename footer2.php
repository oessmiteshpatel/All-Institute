							...
							<div class="col-md-6 col-sm-6">
								<ul id="gform_fields_6" class="gform_fields top_label form_sublabel_below description_below">
									...
									<li id="field_6_3" class="gfield gfield_contains_required field_sublabel_below field_description_below">
										...
										<div class="ginput_container">
											<input name="email" class="large" placeholder="* Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" type="email" maxlength="50" required oninvalid="this.setCustomValidity('Please enter a valid email address')" oninput="setCustomValidity('')">
										</div>
									</li>
