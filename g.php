...
<div id="container">
    ...
    <div id="mega-menu" class="">
              <nav role="navigation">
              <div class="center" style="text-align:right;"><a href="http://www.aerexperts.com/" target="_blank"class="button btn-red btn-purple"style="padding: 4px 0 4px 1px;margin: 5px 115px 0 0;">www.aerexperts.com</a> </div>
        <ul id="menu-main" class="nav top-nav cf" style="padding-left:400px; padding: 0.35em 0 0;">
        ...
        <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_6' >
            ...
            <div class='gform_body'>
                ...
                <li id='field_6_1' class='gfield gfield_contains_required field_sublabel_below field_description_below' >
                    ...
                    <input name='input_1' id='input_6_1' type='text' value='' class='large'  tabindex='1005'  placeholder='First Name*' data-parsley-error-message="Please enter the First Name" />
                  </div>
                        </li>
                <li id='field_6_4' class='gfield field_sublabel_below field_description_below' >
                          ...
                          <div class='ginput_container'>
                    <input name='input_4' id='input_6_4' type='tel' value='' class='large' tabindex='1007'  placeholder='Phone Number*' data-parsley-error-message="Please enter the Contact Number"/>
                  </div>
                        </li>
                <li id='field_6_3' class='gfield gfield_contains_required field_sublabel_below field_description_below' >
                          ...
                          <div class='ginput_container'>
                    <input name='input_3' id='input_6_3' type='email' value='' class='large' tabindex='1008'   placeholder='Email*' data-parsley-error-message="Please enter the valid Email"/>
                  </div>
                        </li>
              </ul>
                    </div>
